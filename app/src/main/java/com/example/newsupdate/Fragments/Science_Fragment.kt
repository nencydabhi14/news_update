...
import com.example.newsupdate.databinding.FragmentScienceBinding
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class Science_Fragment : Fragment() {
        ...
        apiNewsInterFace.getNews(country, category, "d3fbd29b9e584c7d81de1ec074c971b2")
            .enqueue(object : Callback<NewsModelData> {
                override fun onResponse(
                    ...
                    binding.scienceRecycler.isVisible = true
    ...
    fun setUpRvNews(list: List<ArticlesItem?>?) {
        ...
        binding.scienceRecycler.adapter = newsAdaptor
        binding.scienceRecycler.layoutManager = lm
    }

    override fun onStart() {
        super.onStart()
        GetScienceNews("in", "science")
    }
}