...
import com.example.newsupdate.databinding.FragmentTechnologyBinding
...
class TechnologyFragment : Fragment() {
    ...
    fun GetTechnologyNews(country: String, category: String){
        ...
        apiNewsInterFace.getNews(country, category, "fd4950e741904254a43930571645080d")
            .enqueue(object : Callback<NewsModelData> {
                override fun onResponse(
                    ...
                    binding.technologyRecycler.isVisible = true
    ...
    fun setUpRvNews(list: List<ArticlesItem?>?) {
        ...
        binding.technologyRecycler.adapter = newsAdaptor
        binding.technologyRecycler.layoutManager = lm
    }

    override fun onStart() {
        super.onStart()

        GetTechnologyNews("in", "technology")
